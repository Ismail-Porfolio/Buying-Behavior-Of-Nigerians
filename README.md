# 🛍️ Buying Behavior Of Nigerians - 2025 Report
This project contains a detailed data analysis on buying habits of Nigerians using Microsoft Excel sheet to analyze data from a  Google Form Survey.

This project analyzes survey data on buying behaviour among Nigerian shoppers. It summarizes respondent demographics, preferred shopping platforms, payment methods, monthly spending categories and key patterns that can inform small businesses and ecommerce operators.

## 📌 Project Overview
This project explores the consumer buying behavior of Nigerians based on survey data collected from 107 respondents across various states. It analyzes how factors like gender, age, location, shopping frequency, platform preference, payment methods, and product categories influence spending habits and decision-making.
